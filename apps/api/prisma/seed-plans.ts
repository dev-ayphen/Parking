...
const DEFAULT_PLANS = [
  ...
  },
  {
    ...
    yearlyPrice: 4990,
    billingCycle: 'MONTHLY',
    features: ['Up to 10 Spaces', 'Analytics Dashboard', 'Revenue Reports', 'CSV Exports', 'Priority Support'],
    iconKey: 'zap',
    colorKey: 'indigo',
    sortOrder: 2,
    maxSpaces: 10,
  ...
  },
  {
    ...
    yearlyPrice: 9990,
    billingCycle: 'MONTHLY',
    features: ['Unlimited Spaces', 'Featured Listings', 'Advanced Analytics', 'CSV Exports', 'Priority Support'],
    iconKey: 'crown',
    colorKey: 'amber',
    sortOrder: 3,
    maxSpaces: -1,
